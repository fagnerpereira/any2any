...
Gem::Specification.new do |spec|
  spec.name = "slim2erb"
  spec.version = Slim2Erb::VERSION
  spec.authors = ["Contributors"]
  spec.email = ["noreply@any2any.dev"]

  spec.summary = "Convert SLIM to ERB"
  spec.description = "Specific converter from SLIM to ERB extracted from any2any."

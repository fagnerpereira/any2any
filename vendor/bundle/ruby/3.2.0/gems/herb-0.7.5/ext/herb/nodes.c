...
// be modified manually. See /app/vendor/bundle/ruby/3.2.0/gems/herb-0.7.5/templates/ext/herb/nodes.c.erb
...
static VALUE rb_erb_content_node_from_c_struct(AST_ERB_CONTENT_NODE_T* erb_content_node) {
  ...
  /* #<Herb::Template::AnalyzedRubyField:0x00007f49e772ab90 @name="analyzed_ruby", @options={:kind=>nil}> */
